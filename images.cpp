...
void DrawImage(image img, float x, float y, float w, float h, float alpha)
{
...
void DrawCentered(image img, float x, float y, float w, float h, float alpha)
{
    DrawImage(img,x-w/2,y-h/2,w,h,alpha);
}

void DrawClip(image img, float x, float y, float w, float h, float sx, float sy, float sw, float sh, float iw, float ih, float alph)
{
    glBindTexture(GL_TEXTURE_2D, img);
